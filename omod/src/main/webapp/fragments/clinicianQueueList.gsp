...
<script>
    ...
    function displayClinicianData(response) {
        ...
        jq.each(response.patientClinicianQueueList, function (index, element) {
                ...
                var encounterUrl = "/" + OPENMRS_CONTEXT_PATH + "/htmlformentryui/htmlform/editHtmlFormWithStandardUi.page?patientId=" + element.patientId + "&formUuid=12de5bc5-352e-4faf-9961-a2125085a75c&encounterId=" + element.encounterId + "&returnUrl=/openmrs/patientqueueing/providerDashboard.page";
